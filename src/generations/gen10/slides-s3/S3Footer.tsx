/**
 * S3Footer — Ultra-premium footer with holographic progress, glow accents, and gradient badge.
 */
import { motion } from 'framer-motion';
import { useSlideNumber } from '@/contexts/SlideNumberContext';
import { useExportContext } from '@/contexts/ExportContext';
import { S3_EASE, S3_SERIF } from './theme';
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 z-20">
      <div className="px-4 sm:px-8 lg:px-12 py-3 sm:py-4 backdrop-blur-[3px]">
        {/* Progress bar — holographic multi-gradient */}
        {showProgress && (
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            {contextHint && (
              <>
                ...
                <span className="text-[10px] tracking-[0.18em] uppercase text-white/30 hidden sm:inline" style={{ fontFamily: S3_SERIF, fontStyle: 'italic' }}>{contextHint}</span>
              </>
            )}
            {sectionLabel && (
              <>
          ...
          >
            ...
            <span className="relative z-10" style={{ fontFamily: S3_SERIF, fontStyle: 'italic' }}>
