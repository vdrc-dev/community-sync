 ...
 * with trails, cinematic light rays, animated light sweep, holographic refraction,
...
interface S3AtmosphereProps {
  ...
  showPlasma?: boolean;
  /** Enable holographic refraction bands */
  showHolographic?: boolean;
  /** Enable chromatic aberration edge effect */
      ...
      {showChromatic && !isExporting && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <motion.div
            ...
            style={{
              boxShadow: `inset 4px 0 30px hsl(${primaryHue} 90% 60% / ${0.04 * opMul}), inset -4px 0 30px hsl(${tertiaryHue} 85% 55% / ${0.04 * opMul}), inset 0 3px 20px hsl(${secondaryHue} 80% 60% / ${0.03 * opMul})`,
            }}
            animate={{
              boxShadow: [
