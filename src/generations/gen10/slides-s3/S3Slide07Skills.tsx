  ...
  return (
    <div className={S3_ROOT_CLASS + ' flex flex-col items-center justify-center ' + S3_CONTENT_PADDING} style={{ background: S3_THEME.background }}>
      ...
      <div className="relative z-10 max-w-5xl mx-auto w-full text-center">
        ...
        <motion.h1 {...m(0.08)} className="text-5xl 2xl:text-6xl font-black text-white tracking-tight mb-1">
          Skills: <span
            style={{
              ...
              <motion.div key={i} {...m(0.2 + i * 0.08)}
                ...
                <div className="relative p-5 flex flex-col items-center gap-3">
                  <div className="w-12 h-12 rounded-xl border flex items-center justify-center"
                      ...
                      <Icon className="w-6 h-6" style={{ color: skill.accent.text }} />
                    </div>
                  <div>
        ...
        {/* Install CTA */}
        <motion.div {...m(0.55)} className="mt-7 inline-flex items-center gap-3 px-5 py-3 rounded-xl border"
