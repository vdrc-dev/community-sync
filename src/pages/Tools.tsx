        ...
        {isLoading ? (
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {filteredTools?.map((tool) => (
              <Card 
                key={tool.id} 
                className="group glass border-border/50 hover:border-primary/30 transition-all hover-lift overflow-hidden"
              >
                <CardContent className="p-5">
                  <div className="flex items-start gap-3 mb-3">
                    {/* Icon */}
                    <div className="w-12 h-12 rounded-lg bg-muted/50 border border-border flex items-center justify-center text-2xl group-hover:border-primary/30 transition-colors">
                      {tool.icon_emoji}
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <Badge 
                      variant="outline" 
                      className={pricingColor(tool.pricing)}
                    >
                      {tool.pricing || 'N/A'}
                    </Badge>
