...
export const SLIDE_REGISTRY: Record<string, ComponentType> = {
  ...
  'S3SlideAgenda': lazy(() => import('@/generations/gen10/slides-s3/S3SlideAgenda').then(m => ({ default: m.S3SlideAgenda }))),
  'S3SlideDivider01Fundamentos': lazy(() => import('@/generations/gen10/slides-s3/S3SlideDivider01Fundamentos').then(m => ({ default: m.S3SlideDivider01Fundamentos }))),
  ...
  'S3SlideDivider02Herramientas': lazy(() => import('@/generations/gen10/slides-s3/S3SlideDivider02Herramientas').then(m => ({ default: m.S3SlideDivider02Herramientas }))),
  ...
  'S3SlideDivider03Aplicacion': lazy(() => import('@/generations/gen10/slides-s3/S3SlideDivider03Aplicacion').then(m => ({ default: m.S3SlideDivider03Aplicacion }))),
